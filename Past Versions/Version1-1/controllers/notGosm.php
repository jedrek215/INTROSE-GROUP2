	...
	if($this->form_validation->run() == TRUE) 
	{
	   ...
	   if($result) {
			...
			if(!$check) {
								 ...
								 if($result2){
								 		foreach ($result2 as $row)
								 		{
								 			...
								 			$this->db->insert('astatus', $stat);
								 				...
								 				echo '<div class="success">'.'Your submission has been successfully created'. '<br>'. '<a href="dts_Cont" class="btn btn-default" >'.'Proceed to DTS'.'</a>'. '<a href="notGosm" class="btn btn-default" >'.'Submit Again'.'</a>'.'</div>';
								 			
								 		}
								 }
							 	else //else getSubID
								   {
								  	echo '<div class="success">'.'Submission Failed'.'<br>'. 'Error' . '<br>'. '<a href="notGosm" class="btn btn-default" >'.'Submit Again'.'</a>'.'</div>';
								   }
			   ...
			   {
			  	echo '<div class="success">'.'Submission Failed'. '<br>'. 'No Activity Title Found'. 'Close'.'</button>'. '<a href="notGosm" class="btn btn-default" >'.'Submit Again'.'</a>'.'</div>';
			   }
		   }
	  	...
	  	echo '<div class="success">'.'Submission Failed'.'<br>'. '<a href="notGosm" class="btn btn-default" >'.'Submit Again'.'</a>'.'</div>';
	   	   }	
