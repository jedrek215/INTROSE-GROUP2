...
<body>
            ...
            <div class="col-lg-12">
                <div class="panel panel-default text-center">
                    ...
                    <div class="panel-body bg-2">
                        ...
                        <button type ="submit" value="Submit a Form" id="updateTerm" class="btn btn-success pull-right" data-toggle="modal" data-target ="#new">Submit a Form</button>
                    </div>
                </div>
                    <div class="row">
        ...
        <div class="modal" id="new3" role="dialog">
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-footer">
                            <button type="button" id="add3" onclick="finalForm()" class="btn btn-success">Submit</button>
    ...
    <div class="modal fade" id="new4" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
         <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                  <h3> Summary Page </h3>
                    ...
                    <div class="modal-body">
                            ...
                            <div>
                             ...
                             <div class="modal-footer">
                            <button type="button" class="btn btn-default fin" data-dismiss="modal">Cancel</button>
...
base_url = '<?=base_url()?>';
    ...
    data =  $("#newForm").serialize()+"&"+ $("#newForm2").serialize()+"&"+ $("#newForm3").serialize();
