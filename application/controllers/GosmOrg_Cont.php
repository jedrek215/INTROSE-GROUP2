...
Class GosmOrg_Cont extends CI_Controller{
    ...
    public function firstForm(){
            ...
            echo json_encode(array("status" => TRUE, "title" => $data['title'], "particulars" => $data['particulars'], "tieUp" => $data['tieUp'], "start" => $data['start'], "end" => $data['end']));
    }
     ...
     public function secondForm(){
            ...
            echo json_encode(array("status" => TRUE, "ActNature" => $data['ActNature'], "ActType" => $data['ActType'], "related" => $data['related'], "budget" => $data['budget'], "venue" => $data['venue'], "Other" =>$data['other']));
    }
